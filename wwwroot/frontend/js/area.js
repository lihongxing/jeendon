...
dsy.add("0_19_11",["莞城区","东城区","南城区","万江区","长安镇","虎门镇","厚街镇","大朗镇","黄江镇","中堂镇","麻涌镇","高埗镇","石碣镇","石龙镇","企石镇","石排镇","常平镇","洪梅镇","道滘镇","沙田镇","凤岗镇","谢岗镇","横沥镇","寮步镇","桥头镇","东坑镇","清溪镇","塘厦镇","大岭山镇","望牛墩镇","樟木头镇","松山湖区"]);
...
function _init_area(ttd){  //初始化函数
	if(ttd==1){
		s=["s_province","s_city","s_county"];
	}else if(ttd==2){
		s=["e_province","e_city","e_county"];
	}else{
		s=["c_province","c_city","c_county"];
	}
