...
$(function(){
    ...
    jQuery.validator.addMethod("isMobile", function(value, element) {
        ...
        return this.optional(element) || (length == 11 && /^(((14[0-9]{1})|17[0-9]{1})|13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8})$/.test(value));
    }, "请正确填写您的手机号码。");
    ...
    // 匹配密码，以字母开头，长度在6-12之间，只能包含字符、数字和下划线。
    jQuery.validator.addMethod("isStrAndNumr", function(value, element) {
