...
<div id="Bphone">
    <form action="<?= Url::toRoute("/eng-account-manage/eng-account-mobile-info")?>" method="post" id="DzhiM" class="DzhiM">
        <ul>
            <li>
            ...
            <li style="text-align: center;">
                ...
                <input type="submit" class="Opisf" value="立即绑定">
            </li>
        </ul>
    </form>
</div>
    ...
    <div id="Bphone">
        <form action="<?= Url::toRoute("/eng-account-manage/eng-account-mobile-info")?>" method="post" id="DzhiM" class="DzhiM">
            <ul>
                <li>
                    <div class="Umingc">手机号：</div>
                    <input id="mobile" readonly name="phone" value="<?=yii::$app->engineer->identity->eng_phone?>" class="Jujsr_1" type="text" placeholder="请输入手机号">
                </li>
                <li>
                    <div class="Umingc">验证码：</div>
                    <input id="" name="code" value="" class="Jujsr_2" type="text" placeholder="">
                ...
                <li style="text-align: center;">
                    <input type="hidden" name="flag" value="<?=$flag?>">
                    <input type="submit" class="Opisf" value="解除绑定">
                </li>
            </ul>
        </form>
    </div>
        ...
        function() {
            $("#Dj_M").click(function() {
                ...
                if(mobile == "") {
                    ...
                    $.ajax({
                        type : "GET",
                        url : "<?=Url::toRoute('/eng-account-manage/eng-account-phone-check')?>",
                        dataType : "json",
                        async: false,
            ...
            $("#Fsong").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?=Url::toRoute('/captcha/validate-eng-identity-phone-captcha')?>",
                    data: {
                        mobile: mobile,
                        yzm: yzm,
