...
<div id="shame">
    ...
    <div class="Urqo"></div>
    <form enctype="multipart/form-data" action="<?=Url::toRoute(['/pay/emp-pay'])?>" method="post" class="DzhiM">
        <h4>订单号：
            <label id="order_number" name="order_number"><?= $order['order_number'] ?></label>
            ...
            <div id="DomainRight">
                ...
                <div class="eitpo">
                        ...
                        <span class="inputStyle">
                            <input class="input1" type="text" readonly="readonly" name="price" id="price" value="<?=$order['order_pay_total_money']?>">
                            ...
                            <div class="payMethod">
                                ...
                                <div class="submitCollection">
                                    ...
                                    <input class="btn03 jtop" type="submit" value="确认充值" name="charge">
                                </div>
                                <div>
