...
<div id="shame">
    ...
    <div class="Urqo"></div>
    <form enctype="multipart/form-data" action="<?=Url::toRoute(['/pay/emp-invoice-pay'])?>" method="post" class="DzhiM">
        <h4>订单号：
            <label id="order_number" name="invoice_order_number"><?= $invoice_order['order_number'] ?></label>
        ...
        <div class="content_right">
            <div id="DomainRight">
                ...
                <div class="eitpo">
                    <dl class="WarmTips DomainBox">
                        <dt>重要提醒:</dt>
                        <dd>在支付操作前请将浏览器的“阻止弹出窗口”前面的勾去掉,支付完成后按页面提示点击“到商城取货”，这样可以确保支付成功</dd>
                    </dl>
                    <div class="managerMainPlate1">
                        ...
                        <span class="inputStyle">
                            <input class="input1" type="text" readonly="readonly" name="price" id="price" value="<?=$invoice_order['invoice_order_pay_total_money']?>">
                        ...
                        <div class="payMethod">
                            <div class="head">
                                <h3>选择快捷支付方式：</h3>
                                （
                                <span class="orange">借记卡/储蓄卡</span>推荐微信支付/支付宝.<span class="orange">信用卡</span>推荐财付通）
                            </div>
                            <div class="clear"></div>
                            <ul class="payMethodMain">
                                ...
                                <li>
                                    <div>
                                        ...
                                        <label for="payMethod4"><em class="payMethod payYinlian"></em></label>
                                    </div>
                                        <span>
                                          余额支付
                                        </span>
                            ...
                            <div class="submitCollection">
                                ...
                                <input type="hidden" name="invoice_order_id" value="<?=$invoice_order['invoice_order_id']?>">
