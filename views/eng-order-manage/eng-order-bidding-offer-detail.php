        ...
        <div class="pion">
            ...
            <table class="outid">
                ...
                <tr>
                    ...
                    <?php if($offer['order_type'] == '结构图纸设计'){?>
                        <td>
                            <?=$offer['order_part_standard']?>
                        </td>
                    <?php }?>
                    <td>
                        <?=$offer['order_bidding_period']?>
                        天
                    </td>
                    <td>
            ...
            <table class="outie">
                ...
                <tr>
                    <td>
                        <?=$offer['task_part_mumber']?>
                    </td>
                    <td>
                        <?=$offer['task_part_type']?>
                    </td>
                    <td>
                        <?=$offer['task_part_material']?>
                    </td>
                    <td>
                        <?=$offer['task_part_thick']?>
                    </td>
                    <td>
                        <?=$offer['task_totalnum']?>
                    </td>
                    <td>
                        <?=$offer['task_mold_type']?>
                    </td>
                    <td>
                        <?=$offer['task_mode_production']?>
                    </td>
                    <td>
                        <?=$offer['task_mold_pieces']?>
                    </td>
                    <td>
                        <a href="<?=$offer['task_parts_number_mold']?>"><img src="/frontend/images/yansuo.png">点击下载</a>
                    </td>
                </tr>
                <tr>
                    <?php if($offer['order_type'] == '结构图纸设计'){?>
...
<!--                    </th>-->
                ...
                <?php if(!empty($offer['procedure'])){?>
                    <?php foreach($offer['procedure'] as $i => $proce){?>
                        <tr>
                            <?php if($offer['order_type'] == '结构图纸设计'){?>
                                <td>
                            ...
                            <?php }?>
                            <td>
                                <?=$proce['task_duration']?>天
                            </td>
                            <?php if($i == 0){?>
                                <td colspan="2" rowspan="<?=count($offer['procedure'])?>">
