                                ...
                                <li class="UOuuA" style="border-bottom: 0 none;">
                                    <div class="Jhyas">
                                        <div class="Enbgd" style="position: relative;">
                                            <div id="Bthk">
                                                <ul>
                                                    <li class="Rhng2"><span class="Fhntb">公司名称:</span><input
                                                    ...
                                                    <li class="Rhng2"><span class="Fhntb">联系人姓名：</span><input
                                                    ...
                                                    <li class="Rhng2"><span class="Fhntb">邮箱：</span><input
                                                    ...
                                                    <li class="Rhng2" style="margin-top: 35px"><span class="Fhntb">手机号码：</span><input
                                            ...
                                            <ul style="width: 400px;float: left">
                                                <li class="Rhng6 Rhng2">
                                                    ...
                                                    <?php if(yii::$app->employer->identity->emp_examine_status == 100){?>
                                                        <input type="Submit" class="Bchneg Bchu_1" name="" value="申请认证"/>
                                                    ...
                                                    <?php }else if(yii::$app->employer->identity->emp_examine_status == 102){?>
                                                        <input type="Submit" class="Bchneg Bchu_1" name="" value="重新认证"/>
                                ...
                                <li class="UOuuA">
                                    <div class="Jhyas">
                                        <div class="Enbgd" style="position: relative;">
                                            <div id="Bthk">
                                                <ul>
                                                    <li class="Rhng2"><span class="Fhntb">真实姓名:</span><input
                                                    ...
                                                    <li class="Rhng2" style="margin-top: -70px;<?php if(yii::$app->employer->identity->emp_examine_status == 101||yii::$app->employer->identity->emp_examine_status == 103 ){ ?>display:none; <?php }?>">
