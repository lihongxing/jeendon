                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-xs-12">
                                        <table class="table table-bordered">
                                            ...
                                            <td>
                                                <?php
                                                $order_design_software_version = ConstantHelper::get_order_byname($results['order_design_software_version'], 'design_software', 1);
                                            ...
                                            <td><?=$results['order_total_period']?></td>
                                            <td>
                                                <?php
                                        ...
                                        <?php if(!empty($results['tasks'])){?>
                                            <?php foreach($results['tasks'] as $key => $tasks){?>
                                                <table class="table table-bordered">
                                                    <thead>
                                                    <tr>
                                                        <th colspan="8">任务号：<?=$tasks[0]['task_parts_id']?></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <td colspan="8" style="white-space: normal;">
                                                                补充说明：<?=$tasks[0]['task_supplementary_notes']?>
                                                            </td>
                                                        </tr>
                                                        <tr>
