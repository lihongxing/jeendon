            ...
            <div class="box box-primary">
                ...
                <form action="" method="post" class="form-horizontal" role="form" enctype="multipart/form-data" id="form1">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">推荐工程师规则设置</label>
                            <div class="col-sm-8 col-xs-12">
                                <select class="form-control valid" name="configure[planning_task_messages]" aria-invalid="false">
                                    <option>请选择</option>
                                    <option <?php if($configure['planning_task_messages'] == 3){?> selected <?php }?> value="3">结构工艺工程师</option>
                                    <option <?php if($configure['planning_task_messages'] == 2){?> selected <?php }?> value="2">工艺工程师</option>
                                    <option <?php if($configure['planning_task_messages'] == 1){?> selected <?php }?> value="1">结构工程师</option>
                                </select>
                            </div>
                        </div>
                    </div>
