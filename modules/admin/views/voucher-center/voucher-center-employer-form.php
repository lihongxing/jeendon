                ...
                <div class="box-body">
                    <form action="#" method="post" class="form-horizontal" role="form" enctype="multipart/form-data" id="form">
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-3 col-md-2 control-label">充值雇主信息</label>
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input name="parentagent" maxlength="30" value="" id="parentagent" class="form-control" readonly="" type="text">
                                    <div class="input-group-btn">
                                        <button class="btn btn-default" type="button" onclick="popwin = $('#modal-module-menus-notice').modal();" data-original-title="" title="">选择需要充值的雇主</button>
                                        <button class="btn btn-danger" type="button" onclick="$('#voucher_emp_id').val('');$('#parentagent').val('');$('#parentagentavatar').hide()" data-original-title="" title="">清除选择</button>
                                    </div>
                                </div>
                                ...
                                <div id="modal-module-menus-notice" class="modal fade" tabindex="-1">
                                    <div class="modal-dialog" style="width: 920px;">
                                        <div class="modal-content">
                                            <div class="modal-header"><button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button><h3>选择需要充值的雇主</h3></div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="input-group">
                                                        <input class="form-control" name="keyword" value="" id="search-kwd-notice" placeholder="请输入雇主昵称/姓名/手机号" type="text">
                            ...
                            <script language="javascript">
                                function search_members() {
                                    ...
                                    $.get('<?=Url::toRoute('/admin/voucher-center/voucher-center-get-employers')?>', {
                                ...
                                function select_member(o) {
                                    ...
                                    $.get('<?=Url::toRoute('/admin/voucher-center/voucher-center-get-employer-orders-invoice')?>', {
                                        ...
                                        if(data.orders != ''){
                                            ...
                                            var html = '';
                                            html += '<tr><td colspan="4" style="text-align: center" >雇主没有待托管费用的订单!</td><tr>';
                                            $('#orders').empty().append(html);
                                        }
                                        ...
                                        if(data.invoiceorders != ''){
                                            ...
                                            var html = '';
                                            html += '<tr><td colspan="4" style="text-align: center" >雇主没有待待支付的发票订单!</td><tr>';
                                            $('#invoiceorders').empty().append(html);
                                        }
                        ...
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">待托管订单列表</label>
                            <div class="col-sm-9 col-xs-12">
                                <div>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="orders" class="orders">
                                            <tr>
                                                <td colspan="4" style="text-align: center" >为选择雇主!</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">待支付发票列表!</label>
                            <div class="col-sm-9 col-xs-12">
                                <table class="table table-bordered">
                                    <thead>
                                    <th width="45px">
                                    ...
                                    <tbody id="invoiceorders" class="invoiceorders">
                                        <td colspan="4" style="text-align: center" >未选择雇主</td>
                                    </tbody>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                ...
                                <div class="form-control-static">支付托管费用金额：<span id="ordersmoney">0</span>（元）</div>
                                <div class="form-control-static">支付发票金额：<span id="invoiceordersmoney">0</span>（元）</div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-md-offset-2 col-lg-offset-1 col-xs-12 col-sm-9 col-md-10 col-lg-21">
                                ...
                                <input value="" id="voucher_emp_id" name="voucher_emp_id" class="form-control" type="hidden">
...
<script>
    function voucher_form_submit(){
        ...
        require(["dialog"], function (dialog) {
            ...
            var voucher_emp_id = $("#voucher_emp_id").val();
            ...
            dialog({
                ...
                ok: function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<?= Url::toRoute(['voucher-center/voucher-center-employer-form'])?>',
                        data: {invoiceorders_id: invoiceorders_id,orders_id: orders_id, voucher_emp_id: voucher_emp_id,voucher_money:voucher_money, _csrf: "<?=yii::$app->request->getCsrfToken()?>"},
                        datatype: "json",
    ...
    function changemoney(voucher_money){
        ...
        var ordersmoney = parseInt($("#ordersmoney").text());
        var invoiceordersmoney = parseInt($("#invoiceordersmoney").text());
        var balancemoney = voucher_money + balance - ordersmoney - invoiceordersmoney;
