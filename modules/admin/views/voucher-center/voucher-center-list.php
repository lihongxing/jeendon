            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="panel-body">
                        <form id="form1" role="form" class="form-horizontal" method="get" action="<?=Url::toRoute('/admin/voucher-center/voucher-center-list')?>">
                ...
                <div class="box-footer clearfix">
                    <div class="btn-group">
                        ...
                        <a class="btn btn-default" href="<?=Url::toRoute('/admin/voucher-center/voucher-center-form')?>">
                            <i class="fa fa-fw fa-plus-square"></i> 新增充值
                        </a>
                    </div>
