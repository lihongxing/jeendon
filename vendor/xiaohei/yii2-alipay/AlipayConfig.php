...
class AlipayConfig
{
    ...
    public function __construct() {
        ...
        $this->_alipayConfig['partner'] = Yii::$app->params['alipayconfig']['alipayPartner'];
        //收款支付宝账号
        $this->_alipayConfig['seller_email'] = Yii::$app->params['alipayconfig']['alipaySellerEmail'];
        //安全检验码，以数字和字母组成的32位字符
        $this->_alipayConfig['key'] = Yii::$app->params['alipayconfig']['alipayKey'];
        //↑↑↑↑↑↑↑↑↑↑请在这里配置您的基本信息↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
        //签名方式 不需修改
