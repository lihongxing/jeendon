...
class BaseFileHelper
{
     ...
     * and language code "zh", the localized file will be looked for as
     * "path/to/zh/view.php". If the file is not found, it will try a fallback with just a language code that is
